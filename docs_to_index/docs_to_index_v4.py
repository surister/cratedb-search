...
# r = requests.get('https://cratedb.com/docs/crate/reference/en/latest/concepts/resiliency.html')
...
for file in file_generator:
    ...
    df = polars.DataFrame(sections, schema_overrides={'metadata': polars.Object, 'section_hierarchy': polars.String})

    print(df)

    df.write_database('fs_search5', 'crate://192.168.88.251:4200', if_table_exists='append')
